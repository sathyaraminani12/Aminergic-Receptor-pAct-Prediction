...
import molformer_args as args
import os
import numpy as np
import random
import getpass
from datasets import load_dataset, concatenate_datasets, load_from_disk
from molformer_pubchem_encoder import Encoder
import pytorch_lightning as pl
from pytorch_lightning.utilities import rank_zero_warn, rank_zero_only, seed
from pytorch_lightning.callbacks import LearningRateMonitor
from pytorch_lightning import seed_everything as molformer_seed_everything
...
class LightningModule(pl.LightningModule):
    ...
    def __init__(self, config, vocab):
        ...
        self.train_config = config
            ...
            #molformer_seed_everything(config.seed)
